...
class Tagger_upd
{
	...
	public function install()
	{
		...
		$tagger = array(
			...
			'item_id'		=> array('type' => 'INT',		'unsigned' => TRUE,	'default' => 1),
			'tag_id'		=> array('type' => 'INT',		'unsigned' => TRUE,	'default' => 1),
			'site_id'		=> array('type' => 'TINYINT',	'unsigned' => TRUE, 'default' => 1),
			'author_id'		=> array('type' => 'INT',		'unsigned' => TRUE, 'default' => 1),
			'type'			=> array('type' => 'SMALLINT',	'unsigned' => TRUE),
			'order'			=> array('type' => 'SMALLINT',	'unsigned' => TRUE, 'default' => 1),
		);
